...
A final type of composent is also present, the old application. The old application still manages the registration of the new taxi drivers. Therefore, the central communicates synchronously with the old data base to exctract the taxi drivers. The old system also send asynchonous messages to the central to inform it about the database modifications.
